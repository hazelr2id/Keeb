...
noremap U <C-r>
noremap d :call CycleList('l', 'n')<CR>
noremap D :call CycleList('l', 'p')<CR>
noremap b g;
noremap B g,
noremap <Space> o<Esc>
noremap <BackSpace> X
...
call Mapmap('<Leader>d', ':call CycleList("c","n")<CR>')
call Mapmap('<Leader>D', ':call CycleList("c","p")<CR>')
" YCM
...
call Mapmap('<Leader>X', '<Plug>(YCMFindSymbolInWorkspace)')
" Nerdtree
call Mapmap('<Leader>x', ':NERDTreeToggle<CR>')
